...
#include "Board.h" 
CaptainCold::CaptainCold(Board* FBoard)
	:Hero(FBoard)
{
...
CaptainCold::~CaptainCold()
{
}

void CaptainCold::skill()
{

}

void CaptainCold::update(const float& dt)
{
	...
	{
		std::cout << std::endl << "Atak CaptainColda";
		this->attack(foe);
		this->elapsed1 = dt;
	}
